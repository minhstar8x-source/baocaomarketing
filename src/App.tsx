...
export default function App() {
    ...
    useEffect(() => {
        ...
        document.addEventListener('input', (e: any) => { if(e.target.classList.contains('auto-format')) e.target.innerText = (window as any).formatNumber(e.target.innerText); });
...
@media print {
    body { background: white !important; padding: 0 !important; margin: 0 !important; display: block !important; background-image: none !important; }
...
.report-info { flex-grow: 1; padding: 12px 15px; cursor: pointer; display: flex; flex-direction: column; gap: 4px; }
...
.btn-del-report { background: transparent; color: rgba(255,255,255,0.3); border: none; padding: 0 15px; cursor: pointer; transition: 0.2s; display: flex; align-items: center; justify-content: center; }
...
.slide-section {
    ...
    display: flex; flex-direction: column; padding: 60px 80px; flex-shrink: 0; border-radius: 24px;
}
...
.hero-content {
    ...
    box-shadow: 0 30px 60px rgba(0,0,0,0.2), inset 0 0 0 1px rgba(255,255,255,0.3); max-width: 900px; color: white;
}
...
.custom-table th, .custom-table td { padding: 15px 20px; border-bottom: 1px solid var(--slate-200); border-right: 1px solid var(--slate-200); }
...
.act-btn { width: 44px; height: 44px; border-radius: 50%; border: none; background: white; cursor: pointer; color: var(--text-muted); display: flex; align-items: center; justify-content: center; font-size: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); transition: 0.2s; border: 1px solid var(--slate-200); }
...
const htmlContent = `
    ...
    <div class="controls-wrapper no-print">
        <div class="main-toolbar hidden" id="main-menu">
            ...
            <div style="display:flex; gap:8px;">
                <button class="btn" style="background:var(--white); border:1px solid var(--slate-200); color:var(--navy); padding:10px;" onclick="window.addNewSlide('blank')" title="Thêm Slide Trắng"><i class="fa-solid fa-plus"></i> Slide</button>
                <button class="btn" style="background:var(--white); border:1px solid var(--slate-200); color:var(--navy); padding:10px;" onclick="window.addNewSlide('app')" title="Thêm Slide App"><i class="fa-solid fa-link"></i> App</button>
            </div>
        </div>
    </div>
    ...
    <div id="zoom-wrapper">
        <div id="deck-container" style="display: flex; flex-direction: column; gap: 70px; align-items: center; width: 100%;">
            ...
            <div class="slide-section" id="slide-2">
                <div class="slide-actions no-print">
                    <button class="act-btn" style="color:var(--success);" onclick="window.addBudgetCard(this)" title="Thêm thẻ ngân sách"><i class="fa-solid fa-plus"></i></button>
                    <button class="act-btn" onclick="window.addNewSlide('blank')" title="Thêm Slide Trắng"><i class="fa-solid fa-file-circle-plus"></i></button>
                    <button class="act-btn" onclick="window.addNewSlide('app')" title="Thêm Slide App"><i class="fa-solid fa-object-group"></i></button>
                ...
                <p contenteditable="true" style="margin-top:auto; font-size:13px; color:var(--text-muted); text-align:right; font-style:italic;">* Nhập trực tiếp số liệu vào các ô trên. Tự động định dạng hàng nghìn. (Bấm dấu + ở góc để thêm thẻ)</p>
            </div>
    ...
    <template id="tpl-default-deck">
        ...
        <div class="slide-section" id="slide-2">
            ...
            <p contenteditable="true" style="margin-top:auto; font-size:13px; color:var(--text-muted); text-align:right; font-style:italic;">* Nhập trực tiếp số liệu vào các ô trên. Tự động định dạng hàng nghìn.</p>
        </div>
    </template>
    ...
    <template id="tpl-blank">
        <div class="slide-section">
            <div class="slide-actions no-print">
                <button class="act-btn" style="color:var(--navy);" onclick="window.addTable(this)" title="Chèn Bảng"><i class="fa-solid fa-table"></i></button>
